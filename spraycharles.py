...
@click.option("--analyze", 'analyze_results', required=False, is_flag=True, type=str, help="Run the results analyzer after each spray interval. False positives are more likely")
